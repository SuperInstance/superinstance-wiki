...
def validate_tagline(tagline: str) -> str:
    ...
    - Strip all HTML tags (especially <script>, <iframe>, etc).
    - Block script/content-injection patterns explicitly.
    ...
    # Block explicit script patterns before stripping
...
def validate_condition(condition: str) -> str:
    ...
    - Max 1024 characters.
    - Must be a valid Python expression (AST-parseable).
    """
...
def create_rule(
    ...
    rule.provenance.add_event("created", f"rule_name={clean_name}")
    return rule
